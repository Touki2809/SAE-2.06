...
public class Tache
{
	...
	/* toString         */
	/*------------------*/
	public String toString( char dateRef, DateFr date )
	{
	    String sRet = "";
	    ...
	    // Date au plus tôt
	    sRet += "  date au plus tôt  : " +  date.toString( dateRef, this.dte_au_tot  ) +  "\n";

		// Date au plus tard
	    sRet += "  date au plus tard : " +  date.toString( dateRef, this.dte_au_tard ) +  "\n";
